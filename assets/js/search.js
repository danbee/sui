var sindex = 0;
var cycle = false;
var sengine = "https://www.duckduckgo.com/?q="; // Default search engine
  ...
  if (text[0] === "/") {
    if (text.indexOf(" ") > -1) {
      switch (option) {
        ...
        case "m":
          window.location =
            "https://www.themoviedb.org/search?query=" + subtext;
          break;
        case "r":
        ...
        case "s":
          window.location =
            "https://open.spotify.com/search/results/" + subtext;
          break;
        case "t":
        ...
        case "y":
          window.location =
            "https://www.youtube.com/results?search_query=" + subtext;
          break;
        case "g":
